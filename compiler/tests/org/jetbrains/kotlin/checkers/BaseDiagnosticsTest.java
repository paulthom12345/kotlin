...
public abstract class BaseDiagnosticsTest
    ...
    private static LanguageVersionSettings parseLanguageVersionSettings(Map<String, String> directiveMap) {
        ...
        if (directives == null) {
            return apiVersion == ApiVersion.LATEST ? null : new LanguageVersionSettingsImpl(LanguageVersion.LATEST, apiVersion);
        }
    ...
    public static class CustomLanguageVersionSettings implements LanguageVersionSettings {
        ...
        public CustomLanguageVersionSettings(@NotNull Map<LanguageFeature, Boolean> values, @NotNull ApiVersion apiVersion) {
            this.values = values;
